...
func _ready() -> void:
	VariablesGlobales.tts_habla("Configuración de graficos",0)
...
func _on_siguiente_pressed() -> void:
	get_tree().change_scene_to_file("res://Juego/scenes/ConfigInicial_controles.tscn")
